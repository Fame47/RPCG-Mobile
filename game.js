(() => {
  ...
  const cardDefs = {
    ...
    shield_block: { name:'Shield Block', hero:'knight', type:'skill', forgeable:true, ranks:{ bronze:{cost:8,blockNext:true,heal:10}, silver:{cost:10,blockNext:true,heal:15}, gold:{cost:12,blockNext:true,heal:25,healPerLevel:3} }, summary:'Block the next enemy attack and restore Health.' },
